    ...
    <div className="landing-page">
      <div className="div">
        <div className="overlap">
          <img className="emoji-waving-hand" alt="Emoji waving hand" src="/img/emoji-waving-hand-sign.svg" />
        ...
        <div className="overlap-group">
          ...
          <img className="img" alt="Emoji waving hand" src="/img/emoji-waving-hand-sign-1.png" />
          <img className="busts-in-silhouette" alt="Busts in silhouette" src="/img/busts-in-silhouette.svg" />
          <img className="robot-final" alt="Robot final" src="/img/robot-final-3-1-1.svg" />
        </div>
        ...
        <img className="icon-mail" alt="Icon mail" src="/img/icon-mail.png" />
      </div>
    </div>
  );
};
